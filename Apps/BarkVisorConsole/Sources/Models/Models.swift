...
struct LoginChallengeRequest: Encodable {
    var challengeToken: String
    var code: String
}

struct LoginOrChallenge: Decodable {
    var token: String?
    var refreshToken: String?
...
enum PasswordLoginResult: Equatable {
    case session(SessionTokens)
    case totpChallenge(token: String, expiresAt: String)
}
