...
APP_SOURCES = [
    ...
    "Sources/Models/CreateVMWizard.swift",
    "Sources/Models/TemplateModels.swift",
    "Sources/Models/FolderBrowse.swift",
    ...
    "Sources/Models/AuditLog.swift",
    "Sources/Services/KeychainStore.swift",
    "Sources/Services/APIClient.swift",
    "Sources/Services/PasskeySupport.swift",
    "Sources/Services/PasskeyAuth.swift",
    ...
    "Sources/Views/CreateVMWizardView.swift",
    "Sources/Views/FolderPickerView.swift",
    ...
    "Sources/Views/AuditLogSection.swift",
...
TEST_SOURCES = [
    ...
    "Tests/CreateVMWizardTests.swift",
    "Tests/PasskeyAuthTests.swift",
    "Tests/AuditLogTests.swift",
    ...
    pbx.append(
        group(
            ...
            [
                ...
                child_file("Sources/Models/CreateVMWizard.swift"),
                child_file("Sources/Models/TemplateModels.swift"),
                child_file("Sources/Models/FolderBrowse.swift"),
                ...
                child_file("Sources/Models/AuditLog.swift"),
            ],
            "Models",
        )
    )
    pbx.append(
        group(
            ...
            [
                ...
                child_file("Sources/Services/PasskeySupport.swift"),
                child_file("Sources/Services/PasskeyAuth.swift"),
    ...
    pbx.append(
        group(
            ...
            [
                ...
                child_file("Sources/Views/CreateVMWizardView.swift"),
                child_file("Sources/Views/FolderPickerView.swift"),
                ...
                child_file("Sources/Views/AuditLogSection.swift"),
    ...
    pbx.append(
        group(
            ...
            [
                ...
                child_file("Tests/CreateVMWizardTests.swift"),
                child_file("Tests/PasskeyAuthTests.swift"),
                child_file("Tests/AuditLogTests.swift"),
