...
| Device detail | Version, platform, arch, accelerator, uptime, default VM disk directory, and GPU passthrough readiness for that Device. Self uses `/api/system/about` and capabilities; members use `/api/home/devices/{id}/v1/system/...`. Unreachable members keep the unknown copy. |
