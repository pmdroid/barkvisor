...
- Categories: chips, All selected by default, one category at a time. Count on chip.
- Disabled cards stay in the list with reason.
- Library Apps tab uses the same filter.
- Prototype: create-app-search.html
