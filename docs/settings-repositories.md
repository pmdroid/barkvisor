...
The **Repositories** tab lists catalog URLs this Home syncs. Templates and images from those catalogs show up in [Create VM](create-workload.md).
...
- Sync status — idle, syncing, synced, or error
- **Sync** to pull the catalog now
- **Remove** on sources you added (built-in catalogs stay)

**Add repository** asks for the type and a catalog URL.
