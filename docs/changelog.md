...
- Template **Onyx** (Lite) in `repos/templates.json`: Ubuntu 24.04, NAT `:80`, cloud-init installs Onyx Lite and points at Home Ollama `http://10.0.2.2:11434`. In-app Chat tab is gone; completions stay on `/v1/chat/completions`.
