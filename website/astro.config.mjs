      ...
      sidebar: [
        {
          ...
          items: [
            ...
            { label: 'Install on macOS', link: '/docs/getting-started/installation/' },
            { label: 'Install on Linux', link: '/docs/linux/' },
            { label: 'Install on Windows', link: '/docs/getting-started/windows/' },
            { label: 'First launch', link: '/docs/getting-started/first-launch/' },
            { label: 'Create your first VM', link: '/docs/getting-started/quickstart/' },
            { label: 'Home and pairing', link: '/docs/guides/home-and-pairing/' },
            { label: 'Create a Workload', link: '/docs/guides/create-workload/' },
            { label: 'GPU passthrough', link: '/docs/guides/gpu-passthrough/' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Workloads', link: '/docs/using/vms/' },
            ...
            { label: 'Logs', link: '/docs/using/logs/' },
            {
              ...
              items: [
                ...
                { label: 'Security', link: '/docs/using/settings/security/' },
