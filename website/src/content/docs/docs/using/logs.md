...
The feed colors lines by level so errors stand out while scanning, with **Pause / Resume / Clear** controls above it. Each Workload's detail page embeds the same stream pre-filtered to that VM — see [Workload details](/docs/using/vm-details/).
...
- [Dashboard](/docs/using/dashboard/)
