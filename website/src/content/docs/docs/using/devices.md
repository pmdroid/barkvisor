...
**Add a {Device}** in the toolbar jumps to **Settings → Pairing**, where you issue the pairing offer. The flow is documented in [Home and pairing](/docs/guides/home-and-pairing/).
