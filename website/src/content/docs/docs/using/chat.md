...
The empty state says so and links the fix: grant the Home access to Ollama and pull a model first — see [Ollama](/docs/using/ollama/) and the [Ollama guide](/docs/guides/ollama/).
