...
Downloads follow this Device's architecture by default (see [Images](/docs/using/images/)).
...
- [Create a Workload](/docs/guides/create-workload/) — deploy from templates
