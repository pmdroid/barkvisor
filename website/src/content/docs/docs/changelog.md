...
- GPU attach (PAS-275): Linux Devices list GPUs with their IOMMU group and attach/detach them like USB. Fail closed if IOMMU is not ready. The same card cannot be host and guest. Guest Ollama is `http://127.0.0.1:11434/v1`.
