...
public enum APIContract {
    ...
    public static let routes: [Route] = [
        ...
        Route(method: "POST", path: "/api/auth/login/challenge", stability: .stable),
        Route(method: "POST", path: "/api/auth/refresh", stability: .stable),
        Route(method: "POST", path: "/api/auth/logout", stability: .stable),
        Route(method: "GET", path: "/api/auth/totp", stability: .evolving),
        Route(method: "POST", path: "/api/auth/totp/setup", stability: .evolving),
        Route(method: "POST", path: "/api/auth/totp/confirm", stability: .evolving),
        Route(method: "POST", path: "/api/auth/totp/disable", stability: .evolving),
        Route(method: "POST", path: "/api/auth/totp/recovery-codes", stability: .evolving),
