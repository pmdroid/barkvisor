...
public enum APIContract {
    ...
    public static let routes: [Route] = [
        ...
        Route(method: "POST", path: "/api/auth/passkeys/login/begin", stability: .evolving),
        Route(method: "POST", path: "/api/auth/passkeys/login/finish", stability: .evolving),
        Route(method: "GET", path: "/api/auth/passkeys", stability: .evolving),
        Route(method: "DELETE", path: "/api/auth/passkeys/{id}", stability: .evolving),
        Route(method: "POST", path: "/api/auth/passkeys/register/begin", stability: .evolving),
        Route(method: "POST", path: "/api/auth/passkeys/register/finish", stability: .evolving),
        ...
        Route(method: "GET", path: "/api/catalog/apps", stability: .evolving),
        ...
        Route(method: "PUT", path: "/api/system/updates/settings", stability: .evolving),
        Route(method: "GET", path: "/api/system/device-name", stability: .evolving),
        Route(method: "PUT", path: "/api/system/device-name", stability: .evolving),
        ...
        Route(method: "GET", path: "/api/setup/library", stability: .evolving),
        Route(method: "PUT", path: "/api/setup/library", stability: .evolving),
        ...
        Route(method: "GET", path: "/api/setup/status", stability: .evolving),
        ...
        Route(method: "GET", path: "/api/settings/security", stability: .evolving),
        Route(method: "PUT", path: "/api/settings/security", stability: .evolving),
